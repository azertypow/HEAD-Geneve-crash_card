...
/** @type {Resultats}*/   let resultats   // sert pout l'importation des outils de résultats, éviter de modifier
/** @type {Graphiques}*/  let graphiques  // sert pout l'importation des outils de graphiques, éviter de modifier

// ------------------------------------------------------------------
// déclaration des paramètres
// [voir "initialisation des paramètres" dans la fonction setup()
...
function setup() {
  ...
  couleurDuCanvas = color(255, 100, 200)
  rectMode(CENTER);
...
function draw() {
  ...
  rectMode(CENTER)
  rect(
      width/2,   // position x | par rapport à l'angle en haut à gauche
      height/2,   // position y | par rapport à l'angle en haut à gauche
      400,  // width
      200,  // height
